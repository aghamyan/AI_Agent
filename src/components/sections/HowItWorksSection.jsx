...
const STEPS = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.5 10.5L12 7l3.5 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        <rect x="4" y="16" width="16" height="4" rx="2" stroke="currentColor" strokeWidth="1.5"/>
      </svg>
    ),
  },
  {
